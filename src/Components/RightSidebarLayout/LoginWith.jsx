...
const LoginWith = () => {
    const {user,handleloginbygoogle,handleloginbygithub} = useContext(userContext);
    ...
    return (
        <div className={user && "hidden"}>
            ...
            <div className='my-5 text-sm text-center'>
                ...
                <div onClick={handleloginbygithub} className='border border-black py-2 font-semibold rounded-md my-2 cursor-pointer'> <FaGithub className='inline-block mr-3' /> Login With Github</div>
            </div>
        </div>
    );
};
